...
<template>
  <div
    v-if="props.toc?.links"
    class="absolute top-0 left-full h-full pl-2em hidden xl:block"
  >
    <nav class="sticky top-24 w-25em">
      <ul>
        <li
        ...
        >
          <span class="flex items-center">
            <span
              v-if="h2.id === currentId"
              class="text-1em absolute right-full i-icon-park-outline-right-small"
            />
