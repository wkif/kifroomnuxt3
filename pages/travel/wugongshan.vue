    ...
    <div class="main-content">
      ...
      <div class="pie-recipe">
        <div class="pie-recipe__title">
          <div class="pie-name">GETTING OUT <br />OF THE MUD PIE</div>
          <div class="pie-serving">
            <svg x="0px" y="0px" viewBox="0 0 463 463">
              ...
              ></path>
              <path
                d="M231.5,199c4.142,0,7.5-3.358,7.5-7.5v-24c0-4.142-3.358-7.5-7.5-7.5s-7.5,3.358-7.5,7.5v24   C224,195.642,227.358,199,231.5,199z"
              ></path>
              <path
                d="M274.197,188.803c1.464,1.464,3.384,2.197,5.303,2.197s3.839-0.732,5.303-2.197c2.929-2.929,2.929-7.678,0-10.606l-16-16   c-2.929-2.929-7.678-2.929-10.606,0c-2.929,2.929-2.929,7.678,0,10.606L274.197,188.803z"
              ></path>
              <path
                d="M183.5,191c1.919,0,3.839-0.732,5.303-2.197l16-16c2.929-2.929,2.929-7.678,0-10.606c-2.929-2.929-7.678-2.929-10.606,0   l-16,16c-2.929,2.929-2.929,7.678,0,10.606C179.661,190.268,181.581,191,183.5,191z"
              ></path>
            </svg>
        ...
        <div class="pie-recipe__steps">
          For the pie shell: Preheat the oven to 350°F. Toss together the crumbs and butter in a
          medium bowl to moisten. Press the mixture onto the bottom and up the sides of a 9½-inch
          deep-dish pie pan.
        </div>
        <div class="pie-recipe__number">2</div>
        <div class="pie-recipe__steps">
          Refrigerate for at least 15 minutes to firm up the butter. Bake in the center of the oven
          for about 10 minutes, or until just set and fragrant. Place on a wire rack to cool to room
          temperature.
        </div>
        <div class="pie-recipe__number">3</div>
        <div class="pie-recipe__steps">
          For the glaze: Heat the chocolate, confectioners’ sugar, butter, cream, and corn syrup in
          a small saucepan over low heat, stirring until smooth. Remove the pan from the heat and
          stir in the almond extract. Let sit until lukewarm.
        </div>
        <div class="pie-recipe__number">4</div>
        <div class="pie-recipe__steps">
          Pour half the glaze into the bottom of the pie shell and spread until even; refrigerate
          for 30 minutes, or until the glaze sets. Reserve the rest of the glaze.
        </div>
        <div class="pie-recipe__number">5</div>
        <div class="pie-recipe__steps">
          For the filling: Let the ice cream sit at room temperature for about 10 minutes, or until
          soft enough to scoop and spread. Spread 2 cups of the ice cream in the pie shell.
        </div>
        <div class="pie-recipe__number">6</div>
        <div class="pie-recipe__steps">
          If the reserved glaze has turned too firm to pour, reheat it over very low heat. Drizzle
          the ice cream with half the remaining glaze and sprinkle with half the almonds.
        </div>
        <div class="pie-recipe__number">7</div>
        <div class="pie-recipe__steps">
          Return to the refrigerator to chill for 15 minutes, then repeat the layers. Freeze for 2
          hours, or until firm.
        </div>
        <div class="pie-recipe__tips">
          ...
          <h4>Ice-cream pies</h4>
          <div class="pie-recipe__tips__text">
            The key to success with frozen pies like this one is patience. You need to make sure
            your ice cream is soft enough to be spreadable, then let it get cold enough to be
            completely firm between each layer. That means a few trips back to the refrigerator as
            you are assembling it and then a good long cooling-off period in the freezer before you
            serve it up. Skimp on time at any point in the process and you won’t have distinct
            layers, just a soupy mess.
          </div>
        </div>
      </div>
      <div class="context__wrapper">
        <aside class="context">
          <div class="explanation">
            A continuation of
            <a href="https://codepen.io/oliviale/full/WJoqNZ" target="_blank">this pen here</a>.
            Also part of the
            <a href="https://codepen.io/collection/DQvYpQ/" target="_blank"
              >CSS Grid collection here</a
            >.
          </div>
        </aside>
        <footer>
          ...
          ><a href="https://github.com/oliviale" target="_blank"
            ><i class="icon-social-github icons"></i></a
...
@lightgray: #eee;
@brown-lighter: #dbc7b1;
@brown-light: #d69762;
@brown: #916953;
@brown-dark: #543b2e;
@brown-reallydark: #26130f;
...
.main-content {
  display: grid;
  grid-template-areas:
    'navigation pie-recipe pie-image'
...
.pie-image {
  grid-area: pie-image;
  background: url('https://meowlivia.s3.us-east-2.amazonaws.com/codepen/Waitress/GettingOutOfMudPie.png')
...
.pie-recipe {
  ...
  &__tips {
    ...
    box-shadow: inset 0 0 0 2px #fff, inset 0 0 0 4px @brown;
    text-align: center;
    padding: 35px;
    svg {
      display: inline-block;
